...
- Utilizar [Variables](https://developers.google.com/web/updates/2016/02/css-variables-why-should-you-care) [CSS](https://www.madebymike.com.au/writing/using-css-variables/) (ó [_Custom Properties_](https://medium.com/@electerious/the-power-of-css-variables-6c4e4ebaf279)) para reutilizar las propiedades relacionadas a `color` y `font-family` en el proyecto 
- [Acá](https://css-tricks.com/what-do-you-name-color-variables/) les dejo una discusión sobre _cómo nombrar colores en CSS_ y [este artículo](https://uxdesign.cc/my-struggle-with-colors-52156c664b87) que plantea un solución interesante
